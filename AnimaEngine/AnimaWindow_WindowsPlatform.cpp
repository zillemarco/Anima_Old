...
#define _ANIMA_ENGINE_KEY_INVALID -2
#define _ANIMA_ENGINE_WNDCLASSNAME L"AnimaEngineWindow"
...
{
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance = LoadLibraryW(L"winmm.dll");
	if (!AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance)
	{
		//_glfwInputError(GLFW_PLATFORM_ERROR, "Win32: Failed to load winmm.dll");
		return false;
	}

	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetDevCaps = (JOYGETDEVCAPS_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance, "joyGetDevCapsW");
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetPos = (JOYGETPOS_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance, "joyGetPos");
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetPosEx = (JOYGETPOSEX_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance, "joyGetPosEx");
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._timeGetTime = (TIMEGETTIME_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance, "timeGetTime");

	if (!AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetDevCaps || !AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetPos || !AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._joyGetPosEx || !AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._timeGetTime)
	{
		//_glfwInputError(GLFW_PLATFORM_ERROR, "Win32: Failed to load winmm functions");
		return false;
	}

	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance = LoadLibraryW(L"user32.dll");
	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance)
	{
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._SetProcessDPIAware = (SETPROCESSDPIAWARE_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance, "SetProcessDPIAware");
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._ChangeWindowMessageFilterEx = (CHANGEWINDOWMESSAGEFILTEREX_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance, "ChangeWindowMessageFilterEx");
	}

	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._instance = LoadLibraryW(L"dwmapi.dll");
	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._instance)
	{
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._DwmIsCompositionEnabled = (DWMISCOMPOSITIONENABLED_T)GetProcAddress(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._instance, "DwmIsCompositionEnabled");
	}
...
{
	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance)
		FreeLibrary(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_winmm._instance);

	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance)
		FreeLibrary(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_user32._instance);

	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._instance)
		FreeLibrary(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_dwmapi._instance);
}
...
bool _AnimaEngineWindowPlatformInit(void)
{
	...
	SystemParametersInfoW(SPI_GETFOREGROUNDLOCKTIMEOUT, 0, &AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_foregroundLockTimeout, 0);
...
void _AnimaEngineWindowPlatformTerminate(void)
{
	...
	SystemParametersInfoW(SPI_SETFOREGROUNDLOCKTIMEOUT, 0, UIntToPtr(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_foregroundLockTimeout), SPIF_SENDCHANGE);
...
{
	const char* version = _ANIMA_ENGINE_VERSION_NUMBER " Win32"
...
{
	RECT clipRect;
	GetClientRect(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, &clipRect);
	ClientToScreen(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, (POINT*)&clipRect.left);
	ClientToScreen(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, (POINT*)&clipRect.right);
	ClipCursor(&clipRect);
}
...
static void hideCursor(AnimaEngineWindow_Base* window)
{
	...
	if (window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorHidden)
	{
		ShowCursor(TRUE);
		window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorHidden = false;
	}

	if (GetCursorPos(&pos))
	{
		if (WindowFromPoint(pos) == window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle)
			SetCursor(NULL);
	}
}
...
static void disableCursor(AnimaEngineWindow_Base* window)
{
	...
	{
		ShowCursor(FALSE);
		window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorHidden = true;
	}

	updateClipRect(window);
	SetCapture(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle);
}
...
// Translates a Windows key to the corresponding ANIMA_ENGINE_ key
//
static int translateKey(WPARAM wParam, LPARAM lParam)
{
	...
	if ((HIWORD(lParam) & 0x100) == 0)
	{
		...
		{
		case VK_INSERT:   return ANIMA_ENGINE_KEY_KP_0;
		case VK_END:      return ANIMA_ENGINE_KEY_KP_1;
		case VK_DOWN:     return ANIMA_ENGINE_KEY_KP_2;
		case VK_NEXT:     return ANIMA_ENGINE_KEY_KP_3;
		case VK_LEFT:     return ANIMA_ENGINE_KEY_KP_4;
		case VK_CLEAR:    return ANIMA_ENGINE_KEY_KP_5;
		case VK_RIGHT:    return ANIMA_ENGINE_KEY_KP_6;
		case VK_HOME:     return ANIMA_ENGINE_KEY_KP_7;
		case VK_UP:       return ANIMA_ENGINE_KEY_KP_8;
		case VK_PRIOR:    return ANIMA_ENGINE_KEY_KP_9;
		case VK_DIVIDE:   return ANIMA_ENGINE_KEY_KP_DIVIDE;
		case VK_MULTIPLY: return ANIMA_ENGINE_KEY_KP_MULTIPLY;
		case VK_SUBTRACT: return ANIMA_ENGINE_KEY_KP_SUBTRACT;
		case VK_ADD:      return ANIMA_ENGINE_KEY_KP_ADD;
		case VK_DELETE:   return ANIMA_ENGINE_KEY_KP_DECIMAL;
		default:          break;
		}
	}
	...
	switch (HIWORD(lParam) & 0xFF)
	{
		...
		// Row 0:
	case 0x29:             return ANIMA_ENGINE_KEY_GRAVE_ACCENT;
	case 0x02:             return ANIMA_ENGINE_KEY_1;
	case 0x03:             return ANIMA_ENGINE_KEY_2;
	case 0x04:             return ANIMA_ENGINE_KEY_3;
	case 0x05:             return ANIMA_ENGINE_KEY_4;
	case 0x06:             return ANIMA_ENGINE_KEY_5;
	case 0x07:             return ANIMA_ENGINE_KEY_6;
	case 0x08:             return ANIMA_ENGINE_KEY_7;
	case 0x09:             return ANIMA_ENGINE_KEY_8;
	case 0x0A:             return ANIMA_ENGINE_KEY_9;
	case 0x0B:             return ANIMA_ENGINE_KEY_0;
	case 0x0C:             return ANIMA_ENGINE_KEY_MINUS;
	case 0x0D:             return ANIMA_ENGINE_KEY_EQUAL;

		// Row 1:
	case 0x10:             return ANIMA_ENGINE_KEY_Q;
	case 0x11:             return ANIMA_ENGINE_KEY_W;
	case 0x12:             return ANIMA_ENGINE_KEY_E;
	case 0x13:             return ANIMA_ENGINE_KEY_R;
	case 0x14:             return ANIMA_ENGINE_KEY_T;
	case 0x15:             return ANIMA_ENGINE_KEY_Y;
	case 0x16:             return ANIMA_ENGINE_KEY_U;
	case 0x17:             return ANIMA_ENGINE_KEY_I;
	case 0x18:             return ANIMA_ENGINE_KEY_O;
	case 0x19:             return ANIMA_ENGINE_KEY_P;
	case 0x1A:             return ANIMA_ENGINE_KEY_LEFT_BRACKET;
	case 0x1B:             return ANIMA_ENGINE_KEY_RIGHT_BRACKET;
		// We do not map 0x2B as this is only on US - use vKeys for this to prevent confusion with 0x56

		// Row 2:
	case 0x1E:             return ANIMA_ENGINE_KEY_A;
	case 0x1F:             return ANIMA_ENGINE_KEY_S;
	case 0x20:             return ANIMA_ENGINE_KEY_D;
	case 0x21:             return ANIMA_ENGINE_KEY_F;
	case 0x22:             return ANIMA_ENGINE_KEY_G;
	case 0x23:             return ANIMA_ENGINE_KEY_H;
	case 0x24:             return ANIMA_ENGINE_KEY_J;
	case 0x25:             return ANIMA_ENGINE_KEY_K;
	case 0x26:             return ANIMA_ENGINE_KEY_L;
	case 0x27:             return ANIMA_ENGINE_KEY_SEMICOLON;
	case 0x28:             return ANIMA_ENGINE_KEY_APOSTROPHE;

		// Row 3:
	case 0x2C:             return ANIMA_ENGINE_KEY_Z;
	case 0x2D:             return ANIMA_ENGINE_KEY_X;
	case 0x2E:             return ANIMA_ENGINE_KEY_C;
	case 0x2F:             return ANIMA_ENGINE_KEY_V;
	case 0x30:             return ANIMA_ENGINE_KEY_B;
	case 0x31:             return ANIMA_ENGINE_KEY_N;
	case 0x32:             return ANIMA_ENGINE_KEY_M;
	case 0x33:             return ANIMA_ENGINE_KEY_COMMA;
	case 0x34:             return ANIMA_ENGINE_KEY_PERIOD;
	case 0x35:             return ANIMA_ENGINE_KEY_SLASH;
	default:               break;
	}
	...
	case VK_SHIFT:
	{
		...
		if ((DWORD)((lParam & 0x01ff0000) >> 16) == scancode)
			return ANIMA_ENGINE_KEY_RIGHT_SHIFT;

		return ANIMA_ENGINE_KEY_LEFT_SHIFT;
	}
	...
	case VK_CONTROL:
	{
		...
		if (lParam & 0x01000000)
			return ANIMA_ENGINE_KEY_RIGHT_CONTROL;
		...
		if (PeekMessageW(&next, NULL, 0, 0, PM_NOREMOVE))
		{
			if (next.message == WM_KEYDOWN || next.message == WM_SYSKEYDOWN || next.message == WM_KEYUP || next.message == WM_SYSKEYUP)
			{
				if (next.wParam == VK_MENU && (next.lParam & 0x01000000) && next.time == time)
				{
					...
					return _ANIMA_ENGINE_KEY_INVALID;
				}
			}
		}

		return ANIMA_ENGINE_KEY_LEFT_CONTROL;
	}
	...
	case VK_MENU:
	{
		// Is this an extended key (i.e. right key)?
		if (lParam & 0x01000000)
			return ANIMA_ENGINE_KEY_RIGHT_ALT;

		return ANIMA_ENGINE_KEY_LEFT_ALT;
	}
	...
	case VK_RETURN:
	{
		// Is this an extended key (i.e. right key)?
		if (lParam & 0x01000000)
			return ANIMA_ENGINE_KEY_KP_ENTER;

		return ANIMA_ENGINE_KEY_ENTER;
	}

		// Funcion keys (non-printable keys)
	case VK_ESCAPE:        return ANIMA_ENGINE_KEY_ESCAPE;
	case VK_TAB:           return ANIMA_ENGINE_KEY_TAB;
	case VK_BACK:          return ANIMA_ENGINE_KEY_BACKSPACE;
	case VK_HOME:          return ANIMA_ENGINE_KEY_HOME;
	case VK_END:           return ANIMA_ENGINE_KEY_END;
	case VK_PRIOR:         return ANIMA_ENGINE_KEY_PAGE_UP;
	case VK_NEXT:          return ANIMA_ENGINE_KEY_PAGE_DOWN;
	case VK_INSERT:        return ANIMA_ENGINE_KEY_INSERT;
	case VK_DELETE:        return ANIMA_ENGINE_KEY_DELETE;
	case VK_LEFT:          return ANIMA_ENGINE_KEY_LEFT;
	case VK_UP:            return ANIMA_ENGINE_KEY_UP;
	case VK_RIGHT:         return ANIMA_ENGINE_KEY_RIGHT;
	case VK_DOWN:          return ANIMA_ENGINE_KEY_DOWN;
	case VK_F1:            return ANIMA_ENGINE_KEY_F1;
	case VK_F2:            return ANIMA_ENGINE_KEY_F2;
	case VK_F3:            return ANIMA_ENGINE_KEY_F3;
	case VK_F4:            return ANIMA_ENGINE_KEY_F4;
	case VK_F5:            return ANIMA_ENGINE_KEY_F5;
	case VK_F6:            return ANIMA_ENGINE_KEY_F6;
	case VK_F7:            return ANIMA_ENGINE_KEY_F7;
	case VK_F8:            return ANIMA_ENGINE_KEY_F8;
	case VK_F9:            return ANIMA_ENGINE_KEY_F9;
	case VK_F10:           return ANIMA_ENGINE_KEY_F10;
	case VK_F11:           return ANIMA_ENGINE_KEY_F11;
	case VK_F12:           return ANIMA_ENGINE_KEY_F12;
	case VK_F13:           return ANIMA_ENGINE_KEY_F13;
	case VK_F14:           return ANIMA_ENGINE_KEY_F14;
	case VK_F15:           return ANIMA_ENGINE_KEY_F15;
	case VK_F16:           return ANIMA_ENGINE_KEY_F16;
	case VK_F17:           return ANIMA_ENGINE_KEY_F17;
	case VK_F18:           return ANIMA_ENGINE_KEY_F18;
	case VK_F19:           return ANIMA_ENGINE_KEY_F19;
	case VK_F20:           return ANIMA_ENGINE_KEY_F20;
	case VK_F21:           return ANIMA_ENGINE_KEY_F21;
	case VK_F22:           return ANIMA_ENGINE_KEY_F22;
	case VK_F23:           return ANIMA_ENGINE_KEY_F23;
	case VK_F24:           return ANIMA_ENGINE_KEY_F24;
	case VK_NUMLOCK:       return ANIMA_ENGINE_KEY_NUM_LOCK;
	case VK_CAPITAL:       return ANIMA_ENGINE_KEY_CAPS_LOCK;
	case VK_SNAPSHOT:      return ANIMA_ENGINE_KEY_PRINT_SCREEN;
	case VK_SCROLL:        return ANIMA_ENGINE_KEY_SCROLL_LOCK;
	case VK_PAUSE:         return ANIMA_ENGINE_KEY_PAUSE;
	case VK_LWIN:          return ANIMA_ENGINE_KEY_LEFT_SUPER;
	case VK_RWIN:          return ANIMA_ENGINE_KEY_RIGHT_SUPER;
	case VK_APPS:          return ANIMA_ENGINE_KEY_MENU;

		// Numeric keypad
	case VK_NUMPAD0:       return ANIMA_ENGINE_KEY_KP_0;
	case VK_NUMPAD1:       return ANIMA_ENGINE_KEY_KP_1;
	case VK_NUMPAD2:       return ANIMA_ENGINE_KEY_KP_2;
	case VK_NUMPAD3:       return ANIMA_ENGINE_KEY_KP_3;
	case VK_NUMPAD4:       return ANIMA_ENGINE_KEY_KP_4;
	case VK_NUMPAD5:       return ANIMA_ENGINE_KEY_KP_5;
	case VK_NUMPAD6:       return ANIMA_ENGINE_KEY_KP_6;
	case VK_NUMPAD7:       return ANIMA_ENGINE_KEY_KP_7;
	case VK_NUMPAD8:       return ANIMA_ENGINE_KEY_KP_8;
	case VK_NUMPAD9:       return ANIMA_ENGINE_KEY_KP_9;
	case VK_DIVIDE:        return ANIMA_ENGINE_KEY_KP_DIVIDE;
	case VK_MULTIPLY:      return ANIMA_ENGINE_KEY_KP_MULTIPLY;
	case VK_SUBTRACT:      return ANIMA_ENGINE_KEY_KP_SUBTRACT;
	case VK_ADD:           return ANIMA_ENGINE_KEY_KP_ADD;
	case VK_DECIMAL:       return ANIMA_ENGINE_KEY_KP_DECIMAL;

		// Printable keys are mapped according to US layout
	case VK_SPACE:         return ANIMA_ENGINE_KEY_SPACE;
	case 0xDC:             return ANIMA_ENGINE_KEY_BACKSLASH;
	case 0xDF:             return ANIMA_ENGINE_KEY_WORLD_1;
	case 0xE2:             return ANIMA_ENGINE_KEY_WORLD_2;
	default:               break;
	}
...
static bool enterFullscreenMode(AnimaEngineWindow_Base* window)
{
	...
	SetWindowPos(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, HWND_TOPMOST, xpos, ypos, mode._width, mode._height, SWP_NOCOPYBITS);
...
static LRESULT CALLBACK windowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SYSKEYDOWN:
	{
		...
		if (key == _ANIMA_ENGINE_KEY_INVALID)
			break;

		if (window->GetKeyCallback())
			window->GetKeyCallback()(window, key, scancode, ANIMA_ENGINE_PRESS, getKeyMods());
	...
	case WM_SYSKEYUP:
	{
		...
		if (wParam == VK_SHIFT)
		{
			...
			if (window->GetKeyCallback())
			{
				window->GetKeyCallback()(window, ANIMA_ENGINE_KEY_LEFT_SHIFT, scancode, ANIMA_ENGINE_RELEASE, mods);
				window->GetKeyCallback()(window, ANIMA_ENGINE_KEY_RIGHT_SHIFT, scancode, ANIMA_ENGINE_RELEASE, mods);
			}
		}
		else if (wParam == VK_SNAPSHOT)
		{
			...
			if (window->GetKeyCallback())
			{
				window->GetKeyCallback()(window, key, scancode, ANIMA_ENGINE_PRESS, mods);
				window->GetKeyCallback()(window, key, scancode, ANIMA_ENGINE_RELEASE, mods);
			}
		}
		else
		{
	...
	case WM_XBUTTONDOWN:
	{
		...
		if (uMsg == WM_LBUTTONDOWN)
		{
			if (window->GetMouseClickCallback())
				window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_LEFT, ANIMA_ENGINE_PRESS, mods);
		}
		else if (uMsg == WM_RBUTTONDOWN)
		{
			if (window->GetMouseClickCallback())
				window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_RIGHT, ANIMA_ENGINE_PRESS, mods);
		}
		else if (uMsg == WM_MBUTTONDOWN)
		{
			if (window->GetMouseClickCallback())
				window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_MIDDLE, ANIMA_ENGINE_PRESS, mods);
		}
		else
		{
			...
			{
				if (window->GetMouseClickCallback())
					window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_4, ANIMA_ENGINE_PRESS, mods);
			}
			else if (HIWORD(wParam) == XBUTTON2)
			{
				if (window->GetMouseClickCallback())
					window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_5, ANIMA_ENGINE_PRESS, mods);
			}
	...
	case WM_XBUTTONUP:
	{
		...
		else
		{
			...
			{
				if (window->GetMouseClickCallback())
					window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_4, ANIMA_ENGINE_RELEASE, mods);
			}
			else if (HIWORD(wParam) == XBUTTON2)
			{
				if (window->GetMouseClickCallback())
					window->GetMouseClickCallback()(window, ANIMA_ENGINE_MOUSE_BUTTON_5, ANIMA_ENGINE_RELEASE, mods);
			}
	...
	case WM_MOUSEMOVE:
	{
		...
		if (newCursorX != window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorX || newCursorY != window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorY)
		{
			int x, y;
			...
			if (window->GetCursorMode() == ANIMA_ENGINE_CURSOR_DISABLED)
			{
				...
				x = newCursorX - window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorX;
				y = newCursorY - window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorY;
			}
			else
			{
				x = newCursorX;
			...
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorX = newCursorX;
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorY = newCursorY;
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorCentered = false;

			if (window->GetCursorMotionCallback())
				window->GetCursorMotionCallback()(window, x, y);
		}

		if (!window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorInside)
		{
			TRACKMOUSEEVENT tme;
			ZeroMemory(&tme, sizeof(tme));
			tme.cbSize = sizeof(tme);
			tme.dwFlags = TME_LEAVE;
			tme.hwndTrack = window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle;
			TrackMouseEvent(&tme);
	...
	case WM_SETCURSOR:
	{
		...
		{
			if (window->GetCursorMode() == ANIMA_ENGINE_CURSOR_HIDDEN || window->GetCursorMode() == ANIMA_ENGINE_CURSOR_DISABLED)
			{
				SetCursor(NULL);
				return TRUE;
			}
...
static void getFullWindowSize(AnimaEngineWindow_Base* window, int clientWidth, int clientHeight, int* fullWidth, int* fullHeight)
{
	...
	AdjustWindowRectEx(&rect, window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle, FALSE, window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwExStyle);
...
static bool createWindow(AnimaEngineWindow_Base* window, const _AnimaEngineWindowwndconfig* wndconfig, const _AnimaEngineWindowctxconfig* ctxconfig, const _AnimaEngineWindowfbconfig* fbconfig)
{
	...
	window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle = WS_CLIPSIBLINGS | WS_CLIPCHILDREN;
	window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwExStyle = WS_EX_APPWINDOW;

	if (window->GetMonitor())
	{
		window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle |= WS_POPUP;
	...
	else
	{
		...
		{
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle |= WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX;

			if (wndconfig->_resizable)
			{
				window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle |= WS_MAXIMIZEBOX | WS_SIZEBOX;
				window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwExStyle |= WS_EX_WINDOWEDGE;
			}
		}
		else
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle |= WS_POPUP;
	...
	if (!wideTitle)
	{
		//_glfwInputError(ANIMA_ENGINE_PLATFORM_ERROR, "Win32: Failed to convert title to wide string");
		return false;
	}

	window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle = CreateWindowExW(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwExStyle,
											_ANIMA_ENGINE_WNDCLASSNAME,
											wideTitle,
											window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle,
											xpos, ypos,
	...
	if (!window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle)
	{
	...
	{
		_AnimaEngineWindow_ChangeWindowMessageFilterEx(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, WM_DROPFILES, MSGFLT_ALLOW, NULL);
		_AnimaEngineWindow_ChangeWindowMessageFilterEx(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, WM_COPYDATA, MSGFLT_ALLOW, NULL);
		_AnimaEngineWindow_ChangeWindowMessageFilterEx(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, WM_COPYGLOBALDATA, MSGFLT_ALLOW, NULL);
	}

	if (wndconfig->_floating && !wndconfig->_monitor)
	{
		SetWindowPos(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOACTIVATE | SWP_NOMOVE | SWP_NOSIZE);
	}

	DragAcceptFiles(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, TRUE);
...
static void destroyWindow(AnimaEngineWindow_Base* window)
{
	...
	if (window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle)
	{
		DestroyWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle);
		window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle = NULL;
	}
}
...
bool _AnimaEngineWindowRegisterWindowClass(void)
{
	...
	wc.lpszClassName = _ANIMA_ENGINE_WNDCLASSNAME;

	// Load user-provided icon if available
	wc.hIcon = LoadIconW(GetModuleHandleW(NULL), L"ANIMA_ENGINE_ICON");
	if (!wc.hIcon)
	{
...
{
	UnregisterClassW(_ANIMA_ENGINE_WNDCLASSNAME, GetModuleHandleW(NULL));
}
...
bool _AnimaEngineWindowPlatformCreateWindow(AnimaEngineWindow_Base* window, const _AnimaEngineWindowwndconfig* wndconfig, const _AnimaEngineWindowctxconfig* ctxconfig, const _AnimaEngineWindowfbconfig* fbconfig)
{
	...
	if (status == _ANIMA_ENGINE_RECREATION_IMPOSSIBLE)
		return false;

	if (status == _ANIMA_ENGINE_RECREATION_REQUIRED)
	{
...
void _AnimaEngineWindowPlatformSetWindowTitle(AnimaEngineWindow_Base* window, const char* title)
{
	...
	SetWindowTextW(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, wideTitle);
	free(wideTitle);
}
...
{
	POINT pos = { 0, 0 };
	ClientToScreen(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, &pos);
...
void _AnimaEngineWindowPlatformSetWindowPos(AnimaEngineWindow_Base* window, int xpos, int ypos)
{
	...
	AdjustWindowRectEx(&rect, window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwStyle, FALSE, window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_dwExStyle);
	SetWindowPos(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, NULL, rect.left, rect.top, 0, 0, SWP_NOACTIVATE | SWP_NOZORDER | SWP_NOSIZE);
}

void _AnimaEngineWindowPlatformGetWindowSize(AnimaEngineWindow_Base* window, int* width, int* height)
{
	RECT area;
	GetClientRect(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, &area);
...
void _AnimaEngineWindowPlatformSetWindowSize(AnimaEngineWindow_Base* window, int width, int height)
{
	...
	else
	{
		...
		SetWindowPos(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, HWND_TOP, 0, 0, fullWidth, fullHeight, SWP_NOACTIVATE | SWP_NOOWNERZORDER | SWP_NOMOVE | SWP_NOZORDER);
	}
}
...
{
	ShowWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, SW_MINIMIZE);
}

void _AnimaEngineWindowPlatformRestoreWindow(AnimaEngineWindow_Base* window)
{
	ShowWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, SW_RESTORE);
}

void _AnimaEngineWindowPlatformShowWindow(AnimaEngineWindow_Base* window)
{
	ShowWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, SW_SHOW);
	BringWindowToTop(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle);
	SetForegroundWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle);
	SetFocus(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle);
}
...
{
	ShowWindow(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, SW_HIDE);
}
...
void _AnimaEngineWindowPlatformPollEvents(AnimaEngine* engine)
{
	...
	if (window)
	{
		...
		// nasty problems
		{
			...
			if (!lshiftDown && window->GetKeys()[ANIMA_ENGINE_KEY_LEFT_SHIFT] == 1)
			{
				if(window->GetKeyCallback())
					window->GetKeyCallback()(window, ANIMA_ENGINE_KEY_LEFT_SHIFT, 0, ANIMA_ENGINE_RELEASE, mods);
			}

			if (!rshiftDown && window->GetKeys()[ANIMA_ENGINE_KEY_RIGHT_SHIFT] == 1)
			{
				if (window->GetKeyCallback())
					window->GetKeyCallback()(window, ANIMA_ENGINE_KEY_RIGHT_SHIFT, 0, ANIMA_ENGINE_RELEASE, mods);
			}
		}

		// Did the cursor move in an focused window that has disabled the cursor
		if (window->GetCursorMode() == ANIMA_ENGINE_CURSOR_DISABLED && !window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorCentered)
		{
			int width, height;
			_AnimaEngineWindowPlatformGetWindowSize(window, &width, &height);
			_AnimaEngineWindowPlatformSetCursorPos(window, width / 2.0, height / 2.0);
			window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorCentered = true;
		}
	}
}
...
void _AnimaEngineWindowPlatformPostEmptyEvent(AnimaEngine* engine)
{
	...
	PostMessage(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle, WM_NULL, 0, 0);
}
...
void _AnimaEngineWindowPlatformSetCursorPos(AnimaEngineWindow_Base* window, double xpos, double ypos)
{
	...
	window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorX = (int)xpos;
	window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_oldCursorY = (int)ypos;
}
...
void _AnimaEngineWindowPlatformApplyCursorMode(AnimaEngineWindow_Base* window)
{
	...
	{
	case ANIMA_ENGINE_CURSOR_NORMAL:
		restoreCursor(window);
		break;
	case ANIMA_ENGINE_CURSOR_HIDDEN:
		hideCursor(window);
		break;
	case ANIMA_ENGINE_CURSOR_DISABLED:
...
void _AnimaEngineWindowPlatformSetCursor(AnimaEngine* engine, AnimaEngineWindow_Base* window, _AnimaEngineWindowcursor* cursor)
{
	...
	if (window->GetCursorMode() == ANIMA_ENGINE_CURSOR_NORMAL && engine->GetFocusedWindow() == window && window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_cursorInside)
	{
		if (cursor)
...
void _AnimaEngineWindowPlatformSetClipboardString(AnimaEngineWindow_Base* window, const char* string)
{
	...
	if (!OpenClipboard(window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle))
	{
...
const char* _AnimaEngineWindowPlatformGetClipboardString(AnimaEngineWindow_Base* window)
{
	...
	{
		//_glfwInputError(ANIMA_ENGINE_FORMAT_UNAVAILABLE, NULL);
		return NULL;
	}
	...
	free(AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_clipboardString);
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_clipboardString = _AnimaEngineWindowCreateUTF8FromWideString((const WCHAR*)GlobalLock(stringHandle));

	GlobalUnlock(stringHandle);
	CloseClipboard();

	if (!AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_WINDOW_STATE->_clipboardString)
	{
...
HWND AnimaEngineWindowGetWin32Window(AnimaEngineWindow_Base* handle)
{
	...
	return window->_GET_ANIMA_ENGINE_PLATFORM_WINDOW_STATE->_handle;
}
	...
	for (adapterIndex = 0;; adapterIndex++)
	{
		...
		for (displayIndex = 0;; displayIndex++)
		{
			...
			if (adapter.StateFlags & DISPLAY_DEVICE_PRIMARY_DEVICE &&
				displayIndex == 0)
			{
				_ANIMA_ENGINE_SWAP_POINTERS(monitors[0], monitors[found], _AnimaEngineWindowmonitor*);
			}
...
{
	if (AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_hasPC)
	{
...
void _AnimaEngineWindowInitTimer(void)
{
	...
	{
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_hasPC = true;
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_resolution = 1.0 / (double)frequency;
	}
	else
	{
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_hasPC = false;
		AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_resolution = 0.001;
	}
...
{
	AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_base = getRawTime() - (unsigned __int64)(time / AnimaEngine::_GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TIME_STATE->_resolution);
}
