...
#ifndef __Anima__AnimaGeometry__
#define __Anima__AnimaGeometry__
...
class ANIMA_ENGINE_EXPORT AnimaGeometryBoneInfo : public AnimaNamedObject
{
	DECLARE_ANIMA_CLASS(AnimaGeometryBoneInfo);

public:
	AnimaGeometryBoneInfo(const AnimaString& name, AnimaAllocator* allocator);
	AnimaGeometryBoneInfo(const AnimaGeometryBoneInfo& src);
	AnimaGeometryBoneInfo(AnimaGeometryBoneInfo&& src);
	~AnimaGeometryBoneInfo();

	AnimaGeometryBoneInfo& operator=(const AnimaGeometryBoneInfo& src);
	AnimaGeometryBoneInfo& operator=(AnimaGeometryBoneInfo&& src);
...
class ANIMA_ENGINE_EXPORT AnimaGeometry : public AnimaSceneObject
{
	DECLARE_ANIMA_CLASS(AnimaGeometry);

public:
	AnimaGeometry(const AnimaString& name, AnimaDataGeneratorsManager* dataGeneratorsManager, AnimaAllocator* allocator);
	AnimaGeometry(const AnimaGeometry& src);
	AnimaGeometry(AnimaGeometry&& src);
	~AnimaGeometry();
	
	AnimaGeometry& operator=(const AnimaGeometry& src);
	AnimaGeometry& operator=(AnimaGeometry&& src);

	bool operator==(const AnimaGeometry& other);
	bool operator!=(const AnimaGeometry& other);
...
public:
	...
	void AddInstance(AnimaGeometryInstance* instance);
	AInt GetInstancesCount() const;
	AnimaGeometryInstance* GetInstance(AInt index) const;
	AnimaGeometryInstance* GetInstanceFromName(const AnimaString& name) const;
...
#endif /* defined(__Anima__AnimaGeometry__) */
