...
extern "C" ANIMA_ENGINE_EXPORT void reportAssertionFailure(const char* expr, const char* fileName, int line);

//class QLabel;
//class QPushButton;
//
//class ANIMA_ENGINE_EXPORT AnimaAssertWindow : public QDialog
//{
//	Q_OBJECT
//
//public:
