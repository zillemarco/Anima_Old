...
AnimaGeometryBoneInfo::AnimaGeometryBoneInfo(const AnimaString& name, AnimaAllocator* allocator)
	: AnimaNamedObject(name, allocator)
{
	IMPLEMENT_ANIMA_CLASS(AnimaGeometryBoneInfo);
}

AnimaGeometryBoneInfo::AnimaGeometryBoneInfo(const AnimaGeometryBoneInfo& src)
...
AnimaGeometryBoneInfo::AnimaGeometryBoneInfo(AnimaGeometryBoneInfo&& src)
	: AnimaNamedObject(src)
	, _boneOffset(src._boneOffset)
	, _finalTransformation(src._finalTransformation)
{
...
AnimaGeometryBoneInfo& AnimaGeometryBoneInfo::operator=(const AnimaGeometryBoneInfo& src)
{
	if (this != &src)
	{
...
AnimaGeometryBoneInfo& AnimaGeometryBoneInfo::operator=(AnimaGeometryBoneInfo&& src)
{
	if (this != &src)
	{
		AnimaNamedObject::operator=(src);
...
AnimaGeometryBoneInfo::~AnimaGeometryBoneInfo()
{
}

void AnimaGeometryBoneInfo::SetBoneOffset(AnimaMatrix boneOffset)
{
	_boneOffset = boneOffset;
}

AnimaMatrix AnimaGeometryBoneInfo::GetBoneOffset() const
{
	return _boneOffset;
}

void AnimaGeometryBoneInfo::SetFinalTransformation(AnimaMatrix finalTransformation)
{
	_finalTransformation = finalTransformation;
}

AnimaMatrix AnimaGeometryBoneInfo::GetFinalTransformation() const
{
...
AnimaGeometry::AnimaGeometry(const AnimaGeometry& src)
	...
	, _geometryInstances(src._geometryInstances)
...
void AnimaGeometry::AddInstance(AnimaGeometryInstance* instance)
{
	if (instance != nullptr)
		_geometryInstances.Add(instance->GetName(), instance);
}
...
AnimaGeometryInstance* AnimaGeometry::GetInstance(AInt index) const
{
	return _geometryInstances[index];
}

AnimaGeometryInstance* AnimaGeometry::GetInstanceFromName(const AnimaString& name) const
{
...
{
	AnimaGeometryCreator::MakePlane(this, _allocator);
}

void AnimaGeometry::MakeCube()
{
	AnimaGeometryCreator::MakeCube(this, _allocator);
}

void AnimaGeometry::MakeIcosahedralSphere(AInt recursionLevel)
{
	AnimaGeometryCreator::MakeIcosahedralSphere(this, recursionLevel, _allocator);
}
...
{
	AnimaGeometryCreator::MakeCylinder(this, topRadius, bottomRadius, height, radialSegments, heightSegments, openEnded, _allocator);
}
