...
public:
	...
	*/
	...
	//	Deprecato					Se sono già state inizializzate in precedenza torna il metodo termina senza reinizializzarle.
	//	Deprecato	 *	\return		Torna true se le estensioni vengono inizializzate correttamente o erano già state
	...
	//	Deprecato					Può servire nel caso in cui si volesse reinizializzare le estensioni GLEW per qualche motivo
