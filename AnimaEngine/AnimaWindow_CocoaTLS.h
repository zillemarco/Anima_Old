...
#define _ANIMA_ENGINE_PLATFORM_LIBRARY_TLS_STATE _AnimaEngineWindowtlsNS ns_tls

#define _GETD_ANIMA_ENGINE_PLATFORM_LIBRARY_TLS_STATE	_AnimaEngineWindowtlsNS* GetPlatformLibraryTLSState() { return &ns_tls; }
#define _GET_ANIMA_ENGINE_PLATFORM_LIBRARY_TLS_STATE	GetPlatformLibraryTLSState()

#define _INIT_STATIC_ANIMA_ENGINE_PLATFORM_LIBRARY_TLS_STATE(class) _AnimaEngineWindowtlsNS class::ns_tls;
