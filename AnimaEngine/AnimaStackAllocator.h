...
class ANIMA_ENGINE_EXPORT AnimaStackAllocator : public AnimaAllocator
{
public:
...
BEGIN_ANIMA_ALLOCATOR_NAMESPACE
{
	...
	{
		void* p = allocator.Allocate(size + sizeof(AnimaStackAllocator), ANIMA_ENGINE_ALIGN_OF(AnimaStackAllocator));
