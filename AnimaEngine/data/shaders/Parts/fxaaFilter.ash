	...
	<Versions>
		<Version>
			...
			<Datas>
				...
				<Data name="REN_FxaaReduceMin" type="FLOAT" />
				<Data name="REN_FxaaReduceMul" type="FLOAT" />
				<Data name="REN_FxaaSpanMax" type="FLOAT" />
			</Datas>
			<Code>
				<![CDATA[
					...
					void main()
					{
						vec2 textureCoord = gl_FragCoord.xy / REN_ScreenSize;
