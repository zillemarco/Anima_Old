...
class ANIMA_ENGINE_EXPORT AnimaLinearAllocator : public AnimaAllocator
{
public:
...
BEGIN_ANIMA_ALLOCATOR_NAMESPACE
{
	...
	{
		void* p = allocator.Allocate(size + sizeof(AnimaLinearAllocator), ANIMA_ENGINE_ALIGN_OF(AnimaLinearAllocator));
