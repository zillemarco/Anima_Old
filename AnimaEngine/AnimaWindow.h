#ifndef _AnimaWindow_h
#define _AnimaWindow_h
...
#if defined ANIMA_ENGINE_WINGDIAPI_DEFINED
#	undef WINGDIAPI
#endif

#if defined ANIMA_ENGINE_CALLBACK_DEFINED
#	undef CALLBACK
#endif
...
#if defined(_ANIMA_ENGINE_COCOA)
#	include "AnimaWindow_CocoaPlatform.h"
#elif defined(_ANIMA_ENGINE_WIN32)
#	include "AnimaWindow_WindowsPlatform.h"
#elif defined(_ANIMA_ENGINE_X11)
#	include "x11_platform.h"
#elif defined(_ANIMA_ENGINE_WAYLAND)
#	include "wl_platform.h"
#elif defined(_ANIMA_ENGINE_MIR)
...
struct _AnimaEngineWindowfbconfig
{
	...
	_ANIMA_ENGINE_PLATFORM_FBCONFIG;
};
...
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformInit(void);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformTerminate(void);
extern "C" ANIMA_ENGINE_EXPORT const char*					_AnimaEngineWindowPlatformGetVersionString(void);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetCursorPos(AnimaEngineWindow_Base* window, double xpos, double ypos);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformApplyCursorMode(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT _AnimaEngineWindowmonitor**	_AnimaEngineWindowPlatformGetMonitors(int* count);
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformIsSameMonitor(_AnimaEngineWindowmonitor* first, _AnimaEngineWindowmonitor* second);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetMonitorPos(_AnimaEngineWindowmonitor* monitor, int* xpos, int* ypos);
extern "C" ANIMA_ENGINE_EXPORT AnimaEngineWindowvidmode*	_AnimaEngineWindowPlatformGetVideoModes(_AnimaEngineWindowmonitor* monitor, int* count);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetVideoMode(_AnimaEngineWindowmonitor* monitor, AnimaEngineWindowvidmode* mode);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetGammaRamp(_AnimaEngineWindowmonitor* monitor, AnimaEngineWindowgammaramp* ramp);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetGammaRamp(_AnimaEngineWindowmonitor* monitor, const AnimaEngineWindowgammaramp* ramp);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetClipboardString(AnimaEngineWindow_Base* window, const char* string);
extern "C" ANIMA_ENGINE_EXPORT const char*					_AnimaEngineWindowPlatformGetClipboardString(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformJoystickPresent(int joy);
extern "C" ANIMA_ENGINE_EXPORT const float*				_AnimaEngineWindowPlatformGetJoystickAxes(int joy, int* count);
extern "C" ANIMA_ENGINE_EXPORT const unsigned char*		_AnimaEngineWindowPlatformGetJoystickButtons(int joy, int* count);
extern "C" ANIMA_ENGINE_EXPORT const char*					_AnimaEngineWindowPlatformGetJoystickName(int joy);
extern "C" ANIMA_ENGINE_EXPORT double						_AnimaEngineWindowPlatformGetTime(void);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetTime(double time);
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformCreateWindow(AnimaEngineWindow_Base* window, const _AnimaEngineWindowwndconfig* wndconfig, const _AnimaEngineWindowctxconfig* ctxconfig, const _AnimaEngineWindowfbconfig* fbconfig);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformDestroyWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetWindowTitle(AnimaEngineWindow_Base* window, const char* title);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetWindowPos(AnimaEngineWindow_Base* window, int* xpos, int* ypos);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetWindowPos(AnimaEngineWindow_Base* window, int xpos, int ypos);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetWindowSize(AnimaEngineWindow_Base* window, int* width, int* height);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetWindowSize(AnimaEngineWindow_Base* window, int width, int height);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetFramebufferSize(AnimaEngineWindow_Base* window, int* width, int* height);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformGetWindowFrameSize(AnimaEngineWindow_Base* window, int* left, int* top, int* right, int* bottom);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformIconifyWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformRestoreWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformShowWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformUnhideWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformHideWindow(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformPollEvents(AnimaEngine* engine);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformWaitEvents(AnimaEngine* engine);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformPostEmptyEvent(AnimaEngine* engine);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformMakeContextCurrent(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT AnimaEngineWindow_Base*		_AnimaEngineWindowPlatformGetCurrentContext(void);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSwapBuffers(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSwapInterval(int interval);
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformExtensionSupported(const char* extension);
extern "C" ANIMA_ENGINE_EXPORT AnimaEngineWindowglproc		_AnimaEngineWindowPlatformGetProcAddress(const char* procname);
extern "C" ANIMA_ENGINE_EXPORT bool						_AnimaEngineWindowPlatformCreateCursor(_AnimaEngineWindowcursor* cursor, const AnimaEngineWindowimage* image, int xhot, int yhot);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformDestroyCursor(_AnimaEngineWindowcursor* cursor);
extern "C" ANIMA_ENGINE_EXPORT void						_AnimaEngineWindowPlatformSetCursor(AnimaEngine* engine, AnimaEngineWindow_Base* window, _AnimaEngineWindowcursor* cursor);

extern "C" ANIMA_ENGINE_EXPORT void _AnimaEngineWindowInputMonitorChange(AnimaEngine* engine);
...
class ANIMA_ENGINE_EXPORT AnimaEngineWindow_Base
{
public:
	...
	void* GetOpenGLContext() { return _GET_ANIMA_ENGINE_PLATFORM_CONTEXT_STATE->_context; }
	...
	_GETD_ANIMA_ENGINE_PLATFORM_WINDOW_STATE;
	_GETD_ANIMA_ENGINE_PLATFORM_CONTEXT_STATE;
...
protected:
	virtual void InternalInit() 
	{
		...
		_cursorPosX = 0.0;
		_cursorPosY = 0.0;
		_cursorMode = ANIMA_ENGINE_CURSOR_NORMAL;
		
		_resolutionMultiplier = 1.0;
		
		_INIT_ANIMA_ENGINE_PLATFORM_WINDOW_STATE;
		_INIT_ANIMA_ENGINE_PLATFORM_CONTEXT_STATE;
	}
...
private:
	...
	int		_cursorMode;
	char	_mouseButtons[ANIMA_ENGINE_MOUSE_BUTTON_LAST + 1];
	char	_keys[ANIMA_ENGINE_KEY_LAST + 1];
	bool	_shouldClose;
	...
	_ANIMA_ENGINE_PLATFORM_WINDOW_STATE;
	_ANIMA_ENGINE_PLATFORM_CONTEXT_STATE;
...
struct _AnimaEngineWindowmonitor
{
	...
	_ANIMA_ENGINE_PLATFORM_MONITOR_STATE;
};
...
struct _AnimaEngineWindowcursor
{
	...
	_ANIMA_ENGINE_PLATFORM_CURSOR_STATE;
};
