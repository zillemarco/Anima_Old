...
class imaxdiv_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["quot"] = _AnimaEngine.imaxdiv_t_quot_set
    __swig_getmethods__["quot"] = _AnimaEngine.imaxdiv_t_quot_get
    if _newclass:
        quot = _swig_property(_AnimaEngine.imaxdiv_t_quot_get, _AnimaEngine.imaxdiv_t_quot_set)
    __swig_setmethods__["rem"] = _AnimaEngine.imaxdiv_t_rem_set
    __swig_getmethods__["rem"] = _AnimaEngine.imaxdiv_t_rem_get
    if _newclass:
        rem = _swig_property(_AnimaEngine.imaxdiv_t_rem_get, _AnimaEngine.imaxdiv_t_rem_set)

    def __init__(self):
        this = _AnimaEngine.new_imaxdiv_t()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _AnimaEngine.delete_imaxdiv_t
    __del__ = lambda self: None
imaxdiv_t_swigregister = _AnimaEngine.imaxdiv_t_swigregister
imaxdiv_t_swigregister(imaxdiv_t)


def imaxabs(n):
    return _AnimaEngine.imaxabs(n)
imaxabs = _AnimaEngine.imaxabs

def imaxdiv(numer, denom):
    return _AnimaEngine.imaxdiv(numer, denom)
imaxdiv = _AnimaEngine.imaxdiv

def wcstoimax(nptr, endptr, base):
    return _AnimaEngine.wcstoimax(nptr, endptr, base)
wcstoimax = _AnimaEngine.wcstoimax

def wcstoumax(nptr, endptr, base):
    return _AnimaEngine.wcstoumax(nptr, endptr, base)
wcstoumax = _AnimaEngine.wcstoumax

def strtoimax(nptr, endptr, base):
    return _AnimaEngine.strtoimax(nptr, endptr, base)
strtoimax = _AnimaEngine.strtoimax

def strtoumax(nptr, endptr, base):
    return _AnimaEngine.strtoumax(nptr, endptr, base)
strtoumax = _AnimaEngine.strtoumax
...
class AnimaGC(_object):
    ...
    __swig_getmethods__["InitializeGLEWExtensions"] = lambda x: _AnimaEngine.AnimaGC_InitializeGLEWExtensions
    if _newclass:
        InitializeGLEWExtensions = staticmethod(_AnimaEngine.AnimaGC_InitializeGLEWExtensions)
...
def AnimaGC_InitializeGLEWExtensions():
    return _AnimaEngine.AnimaGC_InitializeGLEWExtensions()
AnimaGC_InitializeGLEWExtensions = _AnimaEngine.AnimaGC_InitializeGLEWExtensions
