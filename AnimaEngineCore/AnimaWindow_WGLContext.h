...
#define _GETD_ANIMA_ENGINE_CORE_PLATFORM_CONTEXT_STATE	_AnimaEngineWindowcontextWGL* GetPlatformContextState() { return &wgl; }
#define _GET_ANIMA_ENGINE_CORE_PLATFORM_CONTEXT_STATE	GetPlatformContextState()

#define _GETD_ANIMA_ENGINE_CORE_PLATFORM_LIBRARY_CONTEXT_STATE	_AnimaEngineWindowlibraryWGL* GetPlatformLibraryContextState() { return &wgl; }
#define _GET_ANIMA_ENGINE_CORE_PLATFORM_LIBRARY_CONTEXT_STATE	GetPlatformLibraryContextState()

#define _INIT_STATIC_ANIMA_ENGINE_CORE_PLATFORM_LIBRARY_CONTEXT_STATE(class) _AnimaEngineWindowlibraryWGL class::wgl;

#define _INIT_ANIMA_ENGINE_CORE_PLATFORM_CONTEXT_STATE			wgl._dc								= NULL;		\
																wgl._context						= NULL;		\
...
#define _INIT_ANIMA_ENGINE_CORE_PLATFORM_LIBRARY_CONTEXT_STATE	wlg._opengl32._instance = NULL;
...
extern "C" ANIMA_ENGINE_CORE_EXPORT bool _AnimaEngineWindowCreateContext(AnimaEngineWindow_Base* window, const _AnimaEngineWindowctxconfig* ctxconfig, const _AnimaEngineWindowfbconfig* fbconfig);

extern "C" ANIMA_ENGINE_CORE_EXPORT void _AnimaEngineWindowDestroyContext(AnimaEngineWindow_Base* window);
extern "C" ANIMA_ENGINE_CORE_EXPORT int _AnimaEngineWindowAnalyzeContext(AnimaEngineWindow_Base* window, const _AnimaEngineWindowctxconfig* ctxconfig, const _AnimaEngineWindowfbconfig* fbconfig);
